...
import com.drzk.parkingguide.camera.NetSDKLib.NET_ACCESSCTLCARD_TYPE;
import com.drzk.parkingguide.camera.NetSDKLib.NET_ACCESS_DOOROPEN_METHOD;

import java.util.Locale;
import java.util.ResourceBundle;

import static com.drzk.parkingguide.camera.NetSDKLib.NET_ACCESSCTLCARD_STATE.*;
...
public final class Res {
	...
	public String getCardStatus(int status) {
		String statusString = "";
		switch(status) {
			case NET_ACCESSCTLCARD_STATE_UNKNOWN:   // 未知
				statusString = bundle.getString("STATE_UNKNOWN");
				break;
			case NET_ACCESSCTLCARD_STATE_NORMAL:   // 正常
				statusString = bundle.getString("STATE_NORMAL");
				break;
			case NET_ACCESSCTLCARD_STATE_LOSE:   // 挂失
				statusString = bundle.getString("STATE_LOSE");
				break;
			case NET_ACCESSCTLCARD_STATE_LOGOFF:   // 注销
				statusString = bundle.getString("STATE_LOGOFF");
				break;
			case NET_ACCESSCTLCARD_STATE_FREEZE:   // 冻结
				statusString = bundle.getString("STATE_FREEZE");
				break;
			case NET_ACCESSCTLCARD_STATE_ARREARAGE:   // 欠费
				statusString = bundle.getString("STATE_ARREARS"); 
				break;
			case NET_ACCESSCTLCARD_STATE_OVERDUE:  // 逾期
				statusString = bundle.getString("STATE_OVERDUE");
				break;
			case NET_ACCESSCTLCARD_STATE_PREARREARAGE:  // 预欠费
	...
	public int getCardStatusInt(int index) {
		...
		switch(index) {
			case 0:   // 未知
				status = NET_ACCESSCTLCARD_STATE_UNKNOWN;
				break;
			case 1:   // 正常
				status = NET_ACCESSCTLCARD_STATE_NORMAL;
				break;
			case 2:   // 挂失
				status = NET_ACCESSCTLCARD_STATE_LOSE;
				break;
			case 3:   // 注销
				status = NET_ACCESSCTLCARD_STATE_LOGOFF;
				break;
			case 4:   // 冻结
				status = NET_ACCESSCTLCARD_STATE_FREEZE;
				break;
			case 5:   // 欠费
				status = NET_ACCESSCTLCARD_STATE_ARREARAGE;
				break;
			case 6:  // 逾期
				status = NET_ACCESSCTLCARD_STATE_OVERDUE;
				break;
			case 7:  // 预欠费
				status = NET_ACCESSCTLCARD_STATE_PREARREARAGE;
				break;
			default:
				status = NET_ACCESSCTLCARD_STATE_UNKNOWN;
				break;		
