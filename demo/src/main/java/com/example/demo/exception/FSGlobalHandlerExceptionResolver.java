...
@Component
public class FSGlobalHandlerExceptionResolver implements HandlerExceptionResolver, Ordered {
    */
/**
     * 错误KEY
     *//*
...
/**
    ...
    public FSGlobalHandlerExceptionResolver(ServerProperties serverProperties) {
